<x-admin-layout>
    <div class="p-4 sm:p-5 lg:p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Violations</h2>
            <p class="text-gray-500">Track violations committed by sellers.</p>
        </div>
        ...
        <div x-data="{
            ...
            search() {
                ...
                this.timer = setTimeout(() => {
                    fetch('{{ route('seller-compliance.violations-table') }}?search=' + encodeURIComponent(this.q))
                        .then(r => r.text()).then(html => { document.getElementById('violations-table-wrap').innerHTML = html; });
                }, 250);
            }
        }">
            ...
            <div id="violations-table-wrap">
                @include('admin.seller-compliance.partials.violations-table')
            </div>
        </div>
    </div>
</x-admin-layout>