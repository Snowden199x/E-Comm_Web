<x-admin-layout>
    <div class="p-4 sm:p-5 lg:p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Monitor Seller Compliance</h2>
            <p class="text-gray-500">Monitor seller compliance and ensure platform policies are performed.</p>
        </div>
        ...
        <div x-data="{
            ...
            <div id="sellers-table-wrap">
                @include('admin.seller-compliance.partials.sellers-table')
            </div>
        </div>
    </div>
</x-admin-layout>
