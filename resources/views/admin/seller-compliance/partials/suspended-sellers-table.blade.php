<div class="bg-white rounded-2xl p-5 shadow-sm overflow-x-auto">
    <table class="w-full text-sm">
        ...
        <tbody>
                ...
                <tr class="border-b last:border-0">
                    ...
                    <td class="py-3 text-red-600 font-medium">
                        @if (is_null($seller->suspended_until))
                            <span
                                class="px-2 py-1 rounded-full bg-red-100 text-red-700 text-xs font-semibold">Permanent</span>
                        @else
                            <span x-data="{
                            ...
                            setInterval(() => tick(), 1000)" x-text="display"></span>
                        @endif
                    </td>
                    <td class="py-3">
            ...
            @empty
                <tr>
                    <td colspan="5" class="py-8 text-center text-gray-400">No suspended sellers.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
