    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex lg:w-[45%] bg-[#3b1735] flex-col items-center justify-center px-16 py-20">
            <div class="flex flex-col items-center text-center">
                <img src="{{ asset('assets/branding/log-in-logo.svg') }}" alt="Vendo" class="w-full max-w-[340px] mx-auto mb-14">
                <h1 class="text-[2.6rem] font-bold text-white leading-tight mb-2 tracking-tight">Welcome Back!</h1>
                <p class="text-[1rem] font-light text-white/70 tracking-wide">Find What You Love. Vendo It.</p>
            </div>
        </div>
