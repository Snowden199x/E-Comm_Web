    ...
    <div class="min-h-screen flex flex-col lg:flex-row"
        ...
        <div class="w-full lg:w-[72%] flex flex-col bg-white min-h-screen">
            ...
            <div class="flex items-start justify-between px-8 pt-7 pb-2 fade-in-up" style="animation-delay: .05s">
                <div>
                    <a href="{{ url('/') }}" class="inline-flex items-center gap-1 text-[0.75rem] font-medium text-gray-400 hover:text-[#3b1735] mb-1.5 transition-all duration-200 hover:-translate-x-0.5">
