    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-[55%] flex items-center justify-center bg-[#f5f0eb] px-4 py-12 sm:px-8">
            ...
            <div class="w-full max-w-[460px]">
                ...
                <a href="{{ url('/') }}"
                    class="inline-flex items-center gap-1.5 text-[0.8rem] font-medium text-gray-500 hover:text-[#3b1735] mb-5 transition">
                    ...
                    <form method="POST" action="{{ route('seller.login.store') }}" x-data="{ showPassword: false }">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}"
                                placeholder="user@gmail.com" required autofocus autocomplete="username"
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="showPassword = !showPassword"
                                    ...
                                    <svg x-show="!showPassword" xmlns="http://www.w3.org/2000/svg"
                                        class="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="flex items-center gap-3 my-5">
                            ...
                            <span
                                class="text-[0.78rem] text-gray-400 font-normal px-1 border border-gray-200 rounded-full w-7 h-7 flex items-center justify-center">or</span>
                            <div class="flex-1 h-px bg-gray-200"></div>
                        </div>
