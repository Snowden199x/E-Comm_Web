...
<aside class="w-64 bg-[#3b1735] text-white h-full flex flex-col overflow-y-auto">
    ...
    <nav class="flex-1 px-4 space-y-1">
        ...
        <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/5">
            <img src="{{ asset('assets/icons/dashboard/complaints-disputes-menu.svg') }}" alt="" class="w-5 h-5">
        ...
        <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/5">
            <img src="{{ asset('assets/icons/dashboard/account-management-menu.svg') }}" alt="" class="w-5 h-5">
