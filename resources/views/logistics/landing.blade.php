...
<body class="antialiased bg-white text-gray-800">
                ...
                <div class="bg-white/[0.06] border border-white/10 rounded-3xl p-8 w-full max-w-sm backdrop-blur-sm">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="w-11 h-11 rounded-full bg-[#e9c98a]/20 flex items-center justify-center">
                            <svg class="w-5 h-5 text-[#e9c98a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                stroke-width="2">
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        <div class="max-w-xl mb-12">
            ...
            <h2 class="text-[1.9rem] font-bold text-gray-900 mt-2">Built for logistics businesses, not one-off riders.
            </h2>
        </div>
            ...
            @php
                $benefits = [
                    [
                        ...
                        'title' => 'Steady order volume',
                        'desc' => 'Tap into a growing base of Vendo sellers and buyers who need reliable delivery.',
                    ],
                    [
                        'icon' =>
                            'M12 7v10M9 9.5c0-1.4 1.3-2.5 3-2.5s3 1.1 3 2.5-1.3 2-3 2.5-3 1.1-3 2.5 1.3 2.5 3 2.5 3-1.1 3-2.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                        'title' => 'Transparent payouts',
                        'desc' => 'Clear, trackable earnings for every delivery your team completes.',
                    ],
                    [
                        'icon' =>
                            'M12 21s-7-6.5-7-11.5A7 7 0 0112 2a7 7 0 017 7.5C19 14.5 12 21 12 21zM12 9.5a2.3 2.3 0 100 4.6 2.3 2.3 0 000-4.6z',
                        'title' => 'Assignments by coverage area',
                        'desc' => 'Get matched with pickups and drop-offs within the area your business serves.',
                    ],
                    [
                        'icon' => 'M9 12l2 2 4-4M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                        'title' => 'Straightforward onboarding',
                        'desc' => 'Apply online, submit your business documents, and start once you\'re verified.',
                    ],
                    [
                        'icon' => 'M3 21h18M4 21V8l8-5 8 5v13M9 21v-6h6v6',
                        'title' => 'Any fleet size welcome',
                        'desc' => 'Whether you run a few vehicles or a full fleet, your business can apply.',
                    ],
                    [
                        'icon' => 'M18 10a6 6 0 10-12 0c0 5 6 11 6 11s6-6 6-11zM12 2v2',
                        'title' => 'Support when you need it',
                        'desc' => 'Our team is here to help with onboarding questions and day-to-day concerns.',
                    ],
                ];
            @endphp
            @foreach ($benefits as $benefit)
                <div
                    class="border border-gray-100 rounded-2xl p-6 hover:shadow-md hover:border-gray-200 transition-all duration-200">
                    <div class="w-11 h-11 rounded-xl bg-[#f3edf7] flex items-center justify-center mb-4">
                        <svg class="w-5 h-5 text-[#3b1735]" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            stroke-width="1.8">
                ...
                @php
                    $steps = [
                        [
                            ...
                            'title' => 'Apply online',
                            'desc' =>
                                'Fill out the registration form with your business and authorized representative details.',
                        ],
                        [
                            'num' => '02',
                            'title' => 'Submit documents',
                            'desc' => 'Upload a valid ID and your business permit.',
                        ],
                        [
                            'num' => '03',
                            'title' => 'Get verified',
                            'desc' => 'Our team reviews your application and notifies you by email.',
                        ],
                        [
                            'num' => '04',
                            'title' => 'Start operating',
                            'desc' => 'Log in and start receiving delivery assignments in your coverage area.',
                        ],
                    ];
                @endphp
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        <div class="grid lg:grid-cols-2 gap-14 items-center">
            <div>
                <span class="text-[0.78rem] font-semibold text-[#3b1735] uppercase tracking-wide">Before you
                    apply</span>
    ...
    <section class="bg-[#faf7f3] py-20">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            <div
                class="bg-white border border-gray-100 rounded-3xl p-8 lg:p-12 grid lg:grid-cols-[1fr_auto] gap-10 items-center">
                <div>
                    <span class="text-[0.78rem] font-semibold text-[#3b1735] uppercase tracking-wide">Looking to ride,
                        not run a business?</span>
                    ...
                    <p class="text-gray-500 text-[0.9rem] leading-relaxed max-w-lg mb-6">
                        This page is for registering a logistics business. If you want to deliver as an individual
                        rider,
                ...
                <div class="flex flex-col items-center gap-3 justify-self-center">
                    <div class="bg-white border border-gray-200 rounded-2xl p-3 shadow-sm">
                        <img src="{{ asset('assets/logistics/rider-app-qr.png') }}"
                            alt="Scan to get the Vendo Rider app" class="w-32 h-32">
                    </div>
                    <p class="text-[0.7rem] text-gray-400 text-center max-w-[140px]">Scan to download the Vendo Rider
                        app</p>
                </div>
            </div>
        </div>
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-10 pb-20">
        <div class="bg-[#3b1735] rounded-3xl px-8 py-14 lg:py-16 text-center relative overflow-hidden">
            <h2 class="text-[1.8rem] lg:text-[2.1rem] font-bold text-white mb-3">Ready to start earning with Vendo?
            </h2>
