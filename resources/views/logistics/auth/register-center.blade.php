...
<body class="antialiased bg-white">
    ...
    <div class="min-h-screen flex flex-col lg:flex-row"
        ...
        {{-- LEFT PANEL --}}
        <div class="hidden lg:flex lg:w-[28%] relative overflow-y-auto bg-[#402143] flex-col items-start justify-start px-8 py-10">
            ...
            <div class="relative z-10 w-full flex flex-col flex-1">
                ...
                <div class="h-[180px] flex items-center justify-center fade-in-up"
                    ...
                    <img src="{{ asset('assets/icons/registration/left-side-panel/house-left-panel.svg') }}"
                        alt=""
                        class="w-full max-w-[180px] opacity-90 float-illustration">
                </div>
                ...
                <div class="w-full mt-2 fade-in-up" style="animation-delay: .15s">
                    ...
                    <div class="flex flex-col gap-0">
                        ...
                        <div class="flex items-start gap-3 group" :class="step > 1 ? 'cursor-pointer' : ''" @click="if (step > 1) step = 1">
                            <div class="flex flex-col items-center shrink-0">
                                <div class="w-6 h-6 rounded-full text-[0.72rem] font-bold flex items-center justify-center shrink-0 transition-all duration-300"
                                     :class="[step >= 1 ? 'bg-white text-[#3b1735] border border-white' : 'bg-[#402143] border border-white/40 text-white', step > 1 ? 'group-hover:scale-110' : '']">
                                ...
                                <div class="w-px my-1 transition-colors duration-500" :class="step > 1 ? 'bg-white/60' : 'bg-white/20'" style="height: 32px;"></div>
                            </div>
                            <div class="pb-4">
                                <p class="text-[0.9rem] leading-tight transition-colors duration-300" :class="step === 1 ? 'text-white font-bold' : 'text-white/80 font-semibold'">1. Personal Information</p>
                                <p class="text-white/60 text-[0.8rem] font-light leading-snug mt-0.5">Tell us about yourself</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3 group" :class="step > 2 ? 'cursor-pointer' : ''" @click="if (step > 2) step = 2">
                            <div class="flex flex-col items-center shrink-0">
                                <div class="w-6 h-6 rounded-full text-[0.72rem] font-bold flex items-center justify-center shrink-0 transition-all duration-300"
                                     :class="[step >= 2 ? 'bg-white text-[#3b1735] border border-white' : 'bg-[#402143] border border-white/20 text-white/40', step > 2 ? 'group-hover:scale-110' : '']">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full text-[0.72rem] font-bold flex items-center justify-center shrink-0 transition-all duration-300"
                                 :class="step >= 3 ? 'bg-white text-[#3b1735] border border-white' : 'bg-[#402143] border border-white/20 text-white/40'">3</div>
                            <div>
                                <p class="text-[0.9rem] leading-tight transition-colors duration-300" :class="step === 3 ? 'text-white font-bold' : 'text-white/50 font-semibold'">3. Review &amp; Submit</p>
                                <p class="text-white/50 text-[0.8rem] font-light leading-snug mt-0.5">Review your information and submit</p>
                            </div>
                        </div>
        ...
        <div class="w-full lg:w-[72%] flex flex-col bg-white min-h-screen">
            ...
            <div class="flex items-start justify-between px-8 pt-7 pb-2 fade-in-up" style="animation-delay: .05s">
                <div>
                    <a href="{{ route('logistics.landing') }}" class="inline-flex items-center gap-1 text-[0.75rem] font-medium text-gray-400 hover:text-[#3b1735] mb-1.5 transition-all duration-200 hover:-translate-x-0.5">
            ...
            <div class="flex-1 px-8 pb-8 overflow-y-auto">
                ...
                {{-- Step Indicator --}}
                <div class="flex items-center mt-5 mb-1 w-full max-w-[580px] mx-auto gap-0 fade-in-up" style="animation-delay: .1s">
                ...
                {{-- Step labels --}}
                <div class="relative flex w-full max-w-[580px] mx-auto mb-6 mt-1.5 fade-in-up" style="animation-delay: .12s">
                ...
                <form method="POST" action="{{ route('logistics.register.store') }}" enctype="multipart/form-data" @submit.prevent="submitForm($el)" class="fade-in-up" style="animation-delay: .16s">
                    ...
                    <div x-show="step === 1" x-ref="step1"
                        ...
                        <div class="mb-1">
                            ...
                            <p class="text-[0.8rem] text-gray-500 font-normal mb-4">Please provide your personal details.</p>
                        </div>

                        <div class="grid grid-cols-3 gap-3 mb-3">
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">Last Name <span class="text-red-500">*</span></label>
                                <input type="text" name="last_name" required placeholder="Enter last name" class="w-full rounded-md border border-gray-200 bg-white text-gray-800 text-[0.85rem] placeholder-gray-400 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3b1735]/25 focus:border-[#3b1735] transition-all duration-200">
                            </div>
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">First Name <span class="text-red-500">*</span></label>
                                <input type="text" name="first_name" required placeholder="Enter first name" class="w-full rounded-md border border-gray-200 bg-white text-gray-800 text-[0.85rem] placeholder-gray-400 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3b1735]/25 focus:border-[#3b1735] transition-all duration-200">
                            </div>
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">Middle Initial</label>
                                <input type="text" name="middle_initial" placeholder="Enter middle initial" class="w-full rounded-md border border-gray-200 bg-white text-gray-800 text-[0.85rem] placeholder-gray-400 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3b1735]/25 focus:border-[#3b1735] transition-all duration-200">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-3 mb-3">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <label class="text-[0.85rem] font-semibold text-gray-700">Email <span class="text-red-500">*</span></label>
                                    <button type="button"
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">Birthday <span class="text-red-500">*</span></label>
                                <input type="date" name="birthday" required class="w-full rounded-md border border-gray-200 bg-white text-gray-500 text-[0.85rem] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3b1735]/25 focus:border-[#3b1735] transition-all duration-200">
                            </div>
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">Age <span class="text-red-500">*</span></label>
                                <input type="text" name="age" placeholder="--" readonly class="w-full rounded-md border border-gray-200 bg-gray-50 text-gray-500 text-[0.85rem] px-3 py-2 cursor-not-allowed">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-1">
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">Password <span class="text-red-500">*</span></label>
                                <div class="relative">
                                    <input name="password" required x-bind:type="showPassword ? 'text' : 'password'" placeholder="Create a password"
                                    ...
                                    <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center justify-center w-9 text-gray-400 hover:text-gray-600 transition-colors duration-200" tabindex="-1">
                            ...
                            <div>
                                <label class="block text-[0.85rem] font-semibold text-gray-700 mb-1">Confirm Password <span class="text-red-500">*</span></label>
                                <div class="relative">
                                    <input name="password_confirmation" required x-bind:type="showConfirmPassword ? 'text' : 'password'" placeholder="Confirm your password"
                                        class="w-full rounded-md border border-gray-200 bg-white text-gray-800 text-[0.85rem] placeholder-gray-400 px-3 py-2 pr-9 focus:outline-none focus:ring-2 focus:ring-[#3b1735]/25 focus:border-[#3b1735] transition-all duration-200">
                                    <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 flex items-center justify-center w-9 text-gray-400 hover:text-gray-600 transition-colors duration-200" tabindex="-1">
                    ...
                    <div x-show="step === 2" x-cloak x-ref="step2"
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            <button type="button" @click="if (vendoValidateStep($refs.step2)) { vendoRefreshRegistrationReview(); step = 3; }"
                                class="flex items-center gap-1.5 bg-[#3b1735] hover:bg-[#4d1f45] active:bg-[#2e1229] text-white text-[0.85rem] font-semibold rounded-lg px-5 py-2 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97]">
                                Next: Review &amp; Submit
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                            </button>
                    ...
                    <div x-show="step === 3" x-cloak
                        ...
                        <div class="border border-gray-200 rounded-xl p-5 mb-4 transition-shadow duration-300 hover:shadow-sm">
                            ...
                            <div class="grid grid-cols-4 gap-x-6 gap-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-[0.85rem] font-semibold text-gray-800" id="review-municipality">—</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        <span class="text-[0.8rem] text-gray-600 truncate" id="review-valid-id">—</span>
                                    </div>
                                </div>
                        ...
                        <div x-show="formError" x-cloak
                            ...
                            <svg class="w-4 h-4 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><circle cx="12" cy="12" r="9"/><path stroke-linecap="round" d="M12 8v5M12 16h.01"/></svg>
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            <button type="submit"
                                :disabled="!Alpine.store('registration').otpVerified || submitting"
                                :class="(!Alpine.store('registration').otpVerified || submitting) ? 'bg-[#3b1735]/50 cursor-not-allowed' : 'bg-[#3b1735] hover:bg-[#4d1f45] hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97]'"
        ...
        <div x-show="showVerifyModal"
             ...
             @otp-verified.window="showVerifyModal = false">
    ...
    <div x-data
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button type="button" @click="$store.toast.visible = false" class="ml-auto text-white/80 hover:text-white transition-colors duration-200">&times;</button>
    </div>
